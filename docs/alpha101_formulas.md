# Alpha101 Formula Reference

Extracted from `docs/1601.00991v3.pdf`, Appendix A.1.

Note: formulas are lightly normalized from PDF text extraction. Some operators in the source PDF are visually compact and should be checked against the original paper if a formula looks ambiguous.
